...
export function SidebarContainer ({
  ...
  return (
        ...
        >
            <div className={`relative bg-app-primary flex items-center justify-center flex-shrink-0  ${!isDashboardOpen ? 'lg:justify-center' : ''}`}>
                <span className=" text-xl font-semibold leading-8 tracking-wider uppercase whitespace-nowrap">
                    <Link href="/dashboard" title="Ir al Dashboard"
                        ...
                        <Image src='/logo.webp' width={436} height={542} alt='lima 21' priority loading='eager' className='w-16 h-auto' />
                    </Link>
                </span>
