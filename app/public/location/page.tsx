// 'use client' // Si estás usando Next.js con componentes del lado del cliente
...
const isOpenNow = (openingHours: OpeningHour[]): string => {
  ...
  if (!todayHours) return '' // No hay horarios para hoy, no se muestra nada
...
export default function PublicRegister () {
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Selecciona el local de tú reserva</h1>
